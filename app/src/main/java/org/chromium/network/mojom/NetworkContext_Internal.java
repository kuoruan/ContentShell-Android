...
class NetworkContext_Internal {
    ...
    private static final int COMPUTE_HTTP_CACHE_SIZE_ORDINAL = 5;

    private static final int CLEAR_CHANNEL_IDS_ORDINAL = 6;

    private static final int CLEAR_HOST_CACHE_ORDINAL = 7;

    private static final int CLEAR_HTTP_AUTH_CACHE_ORDINAL = 8;

    private static final int CLEAR_REPORTING_CACHE_REPORTS_ORDINAL = 9;

    private static final int CLEAR_REPORTING_CACHE_CLIENTS_ORDINAL = 10;

    private static final int CLEAR_NETWORK_ERROR_LOGGING_ORDINAL = 11;

    private static final int CLOSE_ALL_CONNECTIONS_ORDINAL = 12;

    private static final int SET_NETWORK_CONDITIONS_ORDINAL = 13;

    private static final int SET_ACCEPT_LANGUAGE_ORDINAL = 14;

    private static final int SET_ENABLE_REFERRERS_ORDINAL = 15;

    private static final int SET_CT_POLICY_ORDINAL = 16;

    private static final int CREATE_UDP_SOCKET_ORDINAL = 17;

    private static final int CREATE_TCP_SERVER_SOCKET_ORDINAL = 18;

    private static final int CREATE_TCP_CONNECTED_SOCKET_ORDINAL = 19;

    private static final int CREATE_PROXY_RESOLVING_SOCKET_FACTORY_ORDINAL = 20;

    private static final int CREATE_WEB_SOCKET_ORDINAL = 21;

    private static final int LOOK_UP_PROXY_FOR_URL_ORDINAL = 22;

    private static final int CREATE_NET_LOG_EXPORTER_ORDINAL = 23;

    private static final int PRECONNECT_SOCKETS_ORDINAL = 24;

    private static final int CREATE_P2P_SOCKET_MANAGER_ORDINAL = 25;

    private static final int RESET_URL_LOADER_FACTORIES_ORDINAL = 26;

    private static final int RESOLVE_HOST_ORDINAL = 27;

    private static final int ADD_HSTS_FOR_TESTING_ORDINAL = 28;

    private static final int SET_FAILING_HTTP_TRANSACTION_FOR_TESTING_ORDINAL = 29;
...
HostPortPair host, org.chromium.mojo.bindings.InterfaceRequest<ResolveHostHandle> controlHandle, ResolveHostClient responseClient) {
            ...
            _message.controlHandle = controlHandle;
...
SetFailingHttpTransactionForTestingResponse callback) {
            ...
            try {
                ...
                switch(header.getType()) {
                    ...
                    case RESOLVE_HOST_ORDINAL: {
                        ...
                        getImpl().resolveHost(data.host, data.controlHandle, data.responseClient);
                        return true;
                    }
    ...
    static final class NetworkContextResolveHostParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static NetworkContextResolveHostParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                ...
                result = new NetworkContextResolveHostParams(elementsOrVersion);
                    ...
                    result.responseClient = decoder0.readServiceInterface(20, false, ResolveHostClient.MANAGER);
                    }
        ...
        protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
            ...
            encoder0.encode(this.responseClient, 20, false, ResolveHostClient.MANAGER);
        }
    }
