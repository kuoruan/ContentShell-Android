...
int requestId, org.chromium.gfx.mojom.Rect activeMatchRect, int activeMatchOrdinal) {
            ...
            try {
                ...
                switch(header.getType()) {
                    ...
                    case SET_ACTIVE_MATCH_ORDINAL: {
                        ...
                        getImpl().setActiveMatch(data.requestId, data.activeMatchRect, data.activeMatchOrdinal);
                        return true;
                    }
