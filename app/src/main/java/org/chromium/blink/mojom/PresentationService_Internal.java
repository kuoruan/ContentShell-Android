...
class PresentationService_Internal {
    ...
    private static final int SET_PRESENTATION_CONNECTION_ORDINAL = 7;
...
org.chromium.url.mojom.Url presentationUrl, String presentationId) {
    ...
    static final class PresentationServiceStartPresentationResponseParams extends org.chromium.mojo.bindings.Struct {
        ...
        protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
            ...
            encoder0.encode(this.presentationInfo, 8, true);
    ...
    static final class PresentationServiceSetPresentationConnectionParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static PresentationServiceSetPresentationConnectionParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                final int elementsOrVersion = mainDataHeader.elementsOrVersion;
                result = new PresentationServiceSetPresentationConnectionParams(elementsOrVersion);
                    {
        ...
        protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
            ...
            encoder0.encode(this.controllerConnectionPtr, 16, false, PresentationConnection.MANAGER);
